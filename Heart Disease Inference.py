...
def get_inference_data():
    ...
    '''
    data = pd.read_csv("D:/upgrad/MLOPS Elective/Pre req Module files/10.Practice/inference_heart_disease.csv")
...
# ### Load Saved Model
model = joblib.load('D:/upgrad/MLOPS Elective/model1_adaboost.joblib')
